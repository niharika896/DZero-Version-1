...
public class Chessman : MonoBehaviour
{
    ...
    public Sprite black_queen, black_king, black_rook, black_bishop, black_knight, black_pawn;
    public Sprite white_queen, white_king, white_rook, white_bishop, white_knight, white_pawn;
